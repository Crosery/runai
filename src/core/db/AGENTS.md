...
| `schema.rs` | schema + ALL migrations (monolithic) | `init_schema` (v1–v26) |
...
| `tests.rs` | migration / users / library / resources / router fixtures | unit suite (56 tests, all run) |
