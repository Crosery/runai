<!-- prompt: hook_output | callers: recommend::hook_output::render_hook_output | vars: {MODE},{REASONING_BLOCK},{CANDIDATES_BLOCK},{SESSION_ID_ARG},{ACTIVATION_DIRECTIVE},{SKIP_REMINDER_BLOCK},{SESSION_HISTORY_BLOCK},{FEEDBACK_PROTOCOL_BLOCK} -->
runai 推荐 (mode={MODE})
