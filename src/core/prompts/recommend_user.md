<!-- prompt: recommend_user | callers: recommend::router::recommend_for_user_with_client | vars: {USER_PROMPT},{INTENT_SUMMARY},{BM25_CANDIDATE_LIMIT},{CWD_BLOCK},{PROJECT_CONTEXT_BLOCK},{HISTORY_BLOCK},{CANDIDATE_LISTING},{TOP_K} -->
